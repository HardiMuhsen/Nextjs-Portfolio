...
import project  from '../public/assets/Education-website.png';
        ...
        <div className='w-full'>
            ...
            <div className='absolute top-0 left-0 w-full h-[30vh] lg:h-[40vh] bg-black/80 z-10' />
                ...
                <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
                    <h2 className='py-2'>Education Dashboard</h2>
            ...
            <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8'>
                ...
                <h2>Overview</h2>
                <p>
                Education website is a way to provide learning resources in our country,
                this websites goal is to improve the lives of children through education,
                <br />
                by this way we can provide a good education website to grow our child on it.
